...
const Time: NextPage = () => {
  const [travelCtrler] = useState(
    new TravelPlanController(new UserController(app.store))
  );
    ...
    <PrivatePage>
      <div style={styles.colimnProvider}>
        <div style={styles.leftColumn}>
          <Schedule
            planName={travelPlanProps.planName}
            beginDate={travelPlanProps.beginDate}
            endDate={travelPlanProps.endDate}
          />
